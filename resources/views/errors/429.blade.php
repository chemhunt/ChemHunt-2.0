<x-error-layout>
    <div class="flex items-center">
        <div class="flex flex-col w-full mt-8">
            <p class="ml-6 text-6xl md:text-7xl text-chemhunt-logo text-center tracking-loose">429</p>
            <p class="ml-6 text-5xl md:text-7xl text-chemhunt-logo text-center tracking-loose">Too many requests</p>
