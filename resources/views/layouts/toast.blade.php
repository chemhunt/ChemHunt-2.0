<div class="fixed inset-0 z-40 flex items-end justify-center px-4 py-6 pointer-events-none sm:p-6 sm:items-start sm:justify-end">
    <div id="toast"
        ...
        class="w-full max-w-sm bg-chemhunt-light border border-gray-200 rounded-lg shadow-lg cursor-pointer pointer-events-auto hover:-translate-1" x-cloak>
            ...
            <div class="px-4 py-5">
                <div class="flex items-center">
                    ...
                    <div class="flex-1 w-0 pl-3.5 ml-1 border-l border-gray-100">
                        <p class="text-sm font-medium leading-5 text-chemhunt-logo">
                        ...
                        <p class="text-sm leading-5 text-chemhunt-logo" x-text="message"></p>
                    </div>
                    <div class="flex self-start flex-shrink-0 ml-4">
                        <button @click="show = false;" class="inline-flex -mt-1 text-chemhunt-logo transition duration-150 ease-in-out rounded-full focus:outline-none focus:text-gray-500">
